...
require github.com/alibabacloud-go/tea-rpc v1.3.3
...
require (
	...
	github.com/alibabacloud-go/imageseg-20191230/v3 v3.0.0 // indirect
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.62.717 // indirect
